        ...
        <div class="auth-right d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <p class="mb-32 text-secondary-light text-md">Welcome! please enter your details</p>
                </div>
                <form action="{{ route('register.submit') }}" method="post">
                    ...
                    <div class="icon-field mb-16">
                        ...
                        <input type="number" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Phone" name="phone">
                    </div>
                    <div class="icon-field mb-16">
                        <span class="icon top-50 translate-middle-y">
                            <iconify-icon icon="mage:id-card"></iconify-icon>
                        </span>
                        <input type="text" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Company Name" name="company_name">
                    </div>
                    <div class="icon-field mb-16">
                        <span class="icon top-50 translate-middle-y">
                            <iconify-icon icon="mage:link"></iconify-icon>
                        </span>
                        <input type="url" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Company's Website URL" name="url">
                    </div>
